...
app.post('/cancelDetails', (req, res) => {
  ...
  const mailOptions = {
    from: 'kunaldhanawade7@gmail.com',
    to: req.body.email,
    subject: `Ocean Booking Cancellation Details of ${req.body.firstName} ${req.body.lastName}`,
